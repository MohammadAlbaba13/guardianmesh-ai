...
export interface RunOptions {execution_mode:"SIMULATION"|"LIVE"|"AUTO";ai_mode:"deterministic"|"local_llm";allow_fallback:boolean;manual_approval:boolean;severity?:"LOW"|"MEDIUM"|"HIGH"|"CRITICAL"}
